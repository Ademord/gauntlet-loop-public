...
| --- | --- | --- |
| **The technique**<br>2026<br>Matt Shumer | A prompt from the Claude of Duty work: a harsh, separate critic compares the work blind against a real, named reference, and the loop does not stop until the work wins. | not a file |
