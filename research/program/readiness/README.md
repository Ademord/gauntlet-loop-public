...
Current follow-up: [P011](P011-RECORDER-COVERAGE.md) found no enrollment for six selected recent other tasks or the current controller; the broader snapshot still contains 15 enrolled sessions and 417 events. Installed hooks do not provide broad enrollment. [Accounting and source reasons](P011-recorder-coverage.json) preserve missing costs, contact origin and resolution as unknown. Eight corrected offline groups, independent review and two enrolled positive controls passed. The future-scope decision remains pending; no enrollment behavior or milestone status changed.

Prior integration checkpoint: [P010](P010-CHECKED-EXPORT.md) qualifies one real caller integration of P009: 93 graph methods, 21 independent top-level cases and one fresh PDF with independent visual acceptance. See the [checkpoint](P010-checked-export.json), [offline qualification](P010-qualification.json) and [visual review](P010-visual-acceptance.json). Legacy preflight and broader workflows remain unqualified. Next: whole-task cost and acceptance coverage using existing records, before another paid comparison. Total cost is unknown; no milestone status changes.

Prior library checkpoint: [P009](P009-EXPORT-CHECKS.md) extracts the existing export-receipt check, qualifies 8 valid and 20 known-negative cases, and records [five reuse/fix/defer decisions](P009-triage.json) across the fifty milestones. The utility is available in the repository; production caller integration and full cost coverage remain separate work. [Qualification](P009-qualification.json), [frozen contract](P009-contract.json), [probe criteria](P009-probe-criteria.json), [freeze identities](P009-probe-freeze.json).
