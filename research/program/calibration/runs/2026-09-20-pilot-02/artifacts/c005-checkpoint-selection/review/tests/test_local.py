...
class LocalTests(unittest.TestCase):
    ...
    def test_four_way_tie_chain_picks_last_of_max_equal_instants(self):
        a = {"project": "p", "run_id": "r", "updated_at": "2026-01-01T03:00:00Z", "tag": "a"}
        b = {"project": "p", "run_id": "r", "updated_at": "2026-01-01T05:00:00Z", "tag": "b"}
        c = {"project": "p", "run_id": "r", "updated_at": "2026-01-01T05:00:00Z", "tag": "c"}
        d = {"project": "p", "run_id": "r", "updated_at": "2026-01-01T04:00:00Z", "tag": "d"}
        self.assertEqual(select_latest([a, b, c, d]), [c])

    def test_interleaved_keys_preserve_first_appearance_order(self):
        r1 = {"project": "k1", "run_id": "r", "updated_at": "2026-01-01T01:00:00Z"}
        r2 = {"project": "k2", "run_id": "r", "updated_at": "2026-01-01T01:00:00Z"}
        r3 = {"project": "k1", "run_id": "r", "updated_at": "2026-01-01T09:00:00Z"}
        r4 = {"project": "k3", "run_id": "r", "updated_at": "2026-01-01T01:00:00Z"}
        r5 = {"project": "k2", "run_id": "r", "updated_at": "2026-01-01T09:00:00Z"}
        result = select_latest([r1, r2, r3, r4, r5])
        self.assertEqual([rec["project"] for rec in result], ["k1", "k2", "k3"])

    def test_parse_instant_rejects_edge_cases_without_raising(self):
        malformed = [
            "2026-01-01T10:00:00+25:00",
            "2026-01-01T23:59:60Z",
            "2026-01-01",
            "9999999999999-01-01T10:00:00Z",
            "Z",
        ]
        valid = {"project": "p", "run_id": "r", "updated_at": "2020-01-01T00:00:00Z", "state": "valid"}
        for bad_ts in malformed:
            record = {"project": "p", "run_id": "r", "updated_at": bad_ts, "state": "bad"}
            self.assertEqual(select_latest([record, valid]), [valid])
