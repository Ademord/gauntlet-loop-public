...
This report preserves the original excision analysis. Its token statistics use the incomplete legacy `result.usage` field and are superseded by the [September 20 measurement replay](measurement-replay.md). The [dated log correction](LOG.md#2026-09-20-correction-to-the-interpretation-of-the-september-19-results) records x008's actual nonblocking feedback-driven revision. The raw original rows are unchanged.
